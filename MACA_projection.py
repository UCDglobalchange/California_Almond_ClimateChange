...
load_lasso_coef_path = '/home/shqwu/Almond_code_git/saved_data/'+str(data_ID)+'/lasso_model/'
load_MACA_ACI_csv_path = '/home/shqwu/Almond_code_git/saved_data/'+str(data_ID)+'/MACA_csv/'
save_projected_yield_path = '/home/shqwu/Almond_code_git/saved_data/'+str(data_ID)+'/projection/'
...
for i in range(1,1001):
    print(i)
    locals()['coef'+str(((i-1)//100)+1)][i%100-1] = genfromtxt(str(load_lasso_coef_path)+'coef_'+str(i)+'.csv', delimiter = ',')
for i in range(1,11):
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((656,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_hist'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_hist_prediction_'+str(trial)+'_rcp45.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_hist'][locals()[str(model_list[model_id])+str(trial)+'_hist']<0] = 0
        yield_all_hist = np.column_stack((yield_all_hist,locals()[str(model_list[model_id])+str(trial)+'_hist']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_hist']))
    locals()['model_'+str(model_id)+'_average'] = np.nanmedian(locals()['model_'+str(model_id)], axis = 1) ## change to median
...
for year in range(0,41):
    ...
    yield_average_model_hist_rcp45[year,:] = production_average_model_across_state_hist[year,:]/np.sum(area[year])
    yield_all_hist_rcp45[year,:] = production_all_hist_split_across_state[year,:]/np.sum(area[year])
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_hist_rcp45.npy',yield_across_state_hist_rcp45)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_hist_rcp45.npy',yield_average_model_hist_rcp45)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_hist_rcp45.npy',yield_all_hist_rcp45)
np.save(str(save_projected_yield_path)+'tech_2010/yield_1980_rcp45.npy',yield_1980_rcp45)
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((656,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_hist'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_hist_prediction_'+str(trial)+'_rcp45_s.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_hist'][locals()[str(model_list[model_id])+str(trial)+'_hist']<0] = 0
        yield_all_hist = np.column_stack((yield_all_hist,locals()[str(model_list[model_id])+str(trial)+'_hist']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_hist']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1) ## change to median
...
for year in range(0,41):
    ...
    yield_average_model_hist_rcp45_s[year,:] = production_average_model_across_state_hist[year,:]/np.sum(area[year])
    yield_all_hist_rcp45_s[year,:] = production_all_hist_split_across_state[year,:]/np.sum(area[year])
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_hist_rcp45_s.npy',yield_across_state_hist_rcp45_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_hist_rcp45_s.npy',yield_average_model_hist_rcp45_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_hist_rcp45_s.npy',yield_all_hist_rcp45_s)
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((656,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_hist'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_hist_prediction_'+str(trial)+'_rcp85.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_hist'][locals()[str(model_list[model_id])+str(trial)+'_hist']<0] = 0
        yield_all_hist = np.column_stack((yield_all_hist,locals()[str(model_list[model_id])+str(trial)+'_hist']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_hist']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1) ## change to median
...
for year in range(0,41):
    ...
    yield_average_model_hist_rcp85[year,:] = production_average_model_across_state_hist[year,:]/np.sum(area[year])
    yield_all_hist_rcp85[year,:] = production_all_hist_split_across_state[year,:]/np.sum(area[year])
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_hist_rcp85.npy',yield_across_state_hist_rcp85)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_hist_rcp85.npy',yield_average_model_hist_rcp85)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_hist_rcp85.npy',yield_all_hist_rcp85)
np.save(str(save_projected_yield_path)+'tech_2010/yield_1980_rcp85.npy',yield_1980_rcp85)
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((656,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_hist'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_hist_prediction_'+str(trial)+'_rcp85_s.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_hist'][locals()[str(model_list[model_id])+str(trial)+'_hist']<0] = 0
        yield_all_hist = np.column_stack((yield_all_hist,locals()[str(model_list[model_id])+str(trial)+'_hist']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_hist']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1) ## change to median
...
for year in range(0,41):
    ...
    yield_average_model_hist_rcp85_s[year,:] = production_average_model_across_state_hist[year,:]/np.sum(area[year])
    yield_all_hist_rcp85_s[year,:] = production_all_hist_split_across_state[year,:]/np.sum(area[year])
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_hist_rcp85_s.npy',yield_across_state_hist_rcp85_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_hist_rcp85_s.npy',yield_average_model_hist_rcp85_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_hist_rcp85_s.npy',yield_all_hist_rcp85_s)
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((1264,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_rcp45'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_future_prediction_'+str(trial)+'_rcp45.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_rcp45'][locals()[str(model_list[model_id])+str(trial)+'_rcp45']<0] = 0
        yield_all = np.column_stack((yield_all,locals()[str(model_list[model_id])+str(trial)+'_rcp45']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_rcp45']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1)
...
for year in range(0,79):
    ...
    yield_average_model_future_rcp45[year,:] = production_average_model_across_state_rcp45[year,:]/np.sum(area)
    yield_all_future_rcp45[year,:] = production_all_split_across_state[year,:]/np.sum(area)
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_future_rcp45.npy',yield_across_state_future_rcp45)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_future_rcp45.npy',yield_average_model_future_rcp45)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_future_rcp45.npy',yield_all_future_rcp45)
...
for model_id in range(0,17):
    ...
    for trial in range(1,11):
        print(trial)
        locals()[str(model_list[model_id])+str(trial)+'_rcp45'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_future_prediction_'+str(trial)+'_rcp45_s.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_rcp45'][locals()[str(model_list[model_id])+str(trial)+'_rcp45']<0] = 0
        yield_all = np.column_stack((yield_all,locals()[str(model_list[model_id])+str(trial)+'_rcp45']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_rcp45']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1)
...
for year in range(0,79):
    ...
    yield_average_model_future_rcp45_s[year,:] = production_average_model_across_state_rcp45[year,:]/np.sum(area)
    yield_all_future_rcp45_s[year,:] = production_all_split_across_state[year,:]/np.sum(area)
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_future_rcp45_s.npy',yield_across_state_future_rcp45_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_future_rcp45_s.npy',yield_average_model_future_rcp45_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_future_rcp45_s.npy',yield_all_future_rcp45_s)
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((1264,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_rcp85'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_future_prediction_'+str(trial)+'_rcp85.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_rcp85'][locals()[str(model_list[model_id])+str(trial)+'_rcp85']<0] = 0
        yield_all = np.column_stack((yield_all,locals()[str(model_list[model_id])+str(trial)+'_rcp85']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_rcp85']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1)
...
for year in range(0,79):
    ...
    yield_average_model_future_rcp85[year,:] = production_average_model_across_state_rcp85[year,:]/np.sum(area)
    yield_all_future_rcp85[year,:] = production_all_split_across_state[year,:]/np.sum(area)
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_future_rcp85.npy',yield_across_state_future_rcp85)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_future_rcp85.npy',yield_average_model_future_rcp85)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_future_rcp85.npy',yield_all_future_rcp85)
...
for model_id in range(0,17):
    locals()['model_'+str(model_id)] = np.zeros((1264,0))
    for trial in range(1,11):
        locals()[str(model_list[model_id])+str(trial)+'_rcp85'] = genfromtxt(str(load_MACA_ACI_csv_path)+'tech_2010/'+str(model_list[model_id])+'_future_prediction_'+str(trial)+'_rcp85_s.csv', delimiter=',')
        locals()[str(model_list[model_id])+str(trial)+'_rcp85'][locals()[str(model_list[model_id])+str(trial)+'_rcp85']<0] = 0
        yield_all = np.column_stack((yield_all,locals()[str(model_list[model_id])+str(trial)+'_rcp85']))
        locals()['model_'+str(model_id)] = np.column_stack((locals()['model_'+str(model_id)], locals()[str(model_list[model_id])+str(trial)+'_rcp85']))
    locals()['model_'+str(model_id)+'_average'] = np.median(locals()['model_'+str(model_id)], axis = 1)
...
np.save(str(save_projected_yield_path)+'tech_2010/yield_across_state_future_rcp85_s.npy',yield_across_state_future_rcp85_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_average_model_future_rcp85_s.npy',yield_average_model_future_rcp85_s)
np.save(str(save_projected_yield_path)+'tech_2010/yield_all_future_rcp85_s.npy',yield_all_future_rcp85_s)


np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_hist_rcp45.npy',yield_all_model_hist_rcp45)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_hist_rcp45_s.npy',yield_all_model_hist_rcp45_s)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_hist_rcp85.npy',yield_all_model_hist_rcp85)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_hist_rcp85_s.npy',yield_all_model_hist_rcp85_s)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_future_rcp45.npy',yield_all_model_future_rcp45)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_future_rcp45_s.npy',yield_all_model_future_rcp45_s)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_future_rcp85.npy',yield_all_model_future_rcp85)

np.save(str(save_projected_yield_path)+'tech_2010/yield_all_model_future_rcp85_s.npy',yield_all_model_future_rcp85_s)
