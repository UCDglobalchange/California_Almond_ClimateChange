...
while times <=0:
    ...
    lassocv = LassoCV(alphas=[5,4,3,2,1,0.5,0.1,0.05,0.01,0.005,0.001,0.0005,0.0001,0.00005,0.00001,0.000005,0.000001], max_iter = np.int64(10e4), fit_intercept=False, random_state = trial)
