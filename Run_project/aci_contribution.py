...
for model in range(0,18):
    ...
    locals()['aci_contribution_model_rcp45_copy_'+str(model)] = np.copy(locals()['aci_contribution_model_rcp45_'+str(model)])
    locals()['aci_contribution_model_rcp85_copy_'+str(model)] = np.copy(locals()['aci_contribution_model_rcp85_'+str(model)])
...
aci_contribution_model_rcp45 = np.zeros((18,41,1000,aci_num*2))
aci_contribution_model_rcp85 = np.zeros((18,41,1000,aci_num*2))
for model in range(0,18):
...
for model in range(0,18):
    ...
    locals()['aci_contribution_model_rcp45_future_copy_'+str(model)] = np.copy(locals()['aci_contribution_model_rcp45_future_'+str(model)])
    locals()['aci_contribution_model_rcp85_future_copy_'+str(model)] = np.copy(locals()['aci_contribution_model_rcp85_future_'+str(model)])
...
aci_contribution_model_rcp45_future = np.zeros((18,79,1000,aci_num*2))
aci_contribution_model_rcp85_future = np.zeros((18,79,1000,aci_num*2))
for model in range(0,18):
...
aci_contribution_rcp45_county_hist = np.zeros((16,18,41,1000,aci_num))
aci_contribution_rcp85_county_hist = np.zeros((16,18,41,1000,aci_num))
aci_contribution_rcp45_county_future = np.zeros((16,18,79,1000,aci_num))
aci_contribution_rcp85_county_future = np.zeros((16,18,79,1000,aci_num))
for county in range(0,16):
    for model in range(0,18):
        aci_contribution_rcp45_county_hist[county,model,:,:,:] = np.split(locals()['aci_contribution_model_rcp45_copy_'+str(model)],16)[county][:,:,0:aci_num]+np.split(locals()['aci_contribution_model_rcp45_copy_'+str(model)],16)[county][:,:,aci_num:aci_num*2]
        aci_contribution_rcp85_county_hist[county,model,:,:,:] = np.split(locals()['aci_contribution_model_rcp85_copy_'+str(model)],16)[county][:,:,0:aci_num]+np.split(locals()['aci_contribution_model_rcp85_copy_'+str(model)],16)[county][:,:,aci_num:aci_num*2]
        aci_contribution_rcp45_county_future[county,model,:,:,:] = np.split(locals()['aci_contribution_model_rcp45_future_copy_'+str(model)],16)[county][:,:,0:aci_num]+np.split(locals()['aci_contribution_model_rcp45_future_copy_'+str(model)],16)[county][:,:,aci_num:aci_num*2]
        aci_contribution_rcp85_county_future[county,model,:,:,:] = np.split(locals()['aci_contribution_model_rcp85_future_copy_'+str(model)],16)[county][:,:,0:aci_num]+np.split(locals()['aci_contribution_model_rcp85_future_copy_'+str(model)],16)[county][:,:,aci_num:aci_num*2]
...
aci_contribution_rcp45_county_2090_change =  np.mean((np.mean(aci_contribution_rcp45_county[:,:,-20:,:,:], axis=2)-np.mean(aci_contribution_rcp45_county[:,:,21:41,:,:],axis=2)), axis=1)
...
aci_contribution_rcp85_county_2090_change =  np.mean((np.mean(aci_contribution_rcp85_county[:,:,-20:,:,:], axis=2)-np.mean(aci_contribution_rcp85_county[:,:,21:41,:,:],axis=2)), axis=1)
...
np.save(str(save_path)+'aci_contribution_rcp45_county_total.npy',aci_contribution_rcp45_county)
np.save(str(save_path)+'aci_contribution_rcp85_county_total.npy',aci_contribution_rcp85_county)
