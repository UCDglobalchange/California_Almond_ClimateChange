...
ACI_list = ['DormancyFreeze','DormancyETo','JanPpt','BloomPpt','BloomTmin','BloomFrostDays' ,'BloomETo', 'BloomGDD4','SpH','windspeed','GrowingETo','GrowingGDD4', 'GrowingKDD30','harvest_Ppt']
